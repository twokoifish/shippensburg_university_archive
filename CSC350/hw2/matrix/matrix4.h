 ...
 * 
 */
#ifndef MATRIX4_H // If there is no header defined for MATRIX4, then define one.
#define MATRIX4_H
...
public:
   ...
   */
  Matrix4(float array[ROW_SIZE][COL_SIZE]);
   ...
   */
  static Matrix4 scaleUniform(float uniformFactor);
   ...
   */
  static Matrix4 scale(float xFactor, float yFactor, float zFactor);
   ...
   */
  static Matrix4 translateX(float units);
   ...
   */
  static Matrix4 translateY(float units);
   ...
   */
  static Matrix4 translateZ(float units);
   ...
   */
  static Matrix4 translateUniform(float uniformUnits);
   ...
   */
  static Matrix4 translate(float xUnits, float yUnits, float zUnits);
   ...
   */
  static Matrix4 rotateUniform(float uniformDegrees);
   ...
   */
  static Matrix4 rotate(float xDegrees, float yDegrees, float zDegrees);
  ...
  /**
    ...
    */
  static Matrix4 perspectiveProjection(float far, float near, float degrees);
};
