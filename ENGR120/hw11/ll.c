...
node_t *make_list(int letters[], int n) {
...
node_t *prepend(node_t *head, int c) {
...
node_t *append(node_t *head, int c) {
  node_t *temp = head;
...
node_t *insert_at(node_t *head, int c, int pos) {
  if(!pos) {
...
void insert_after(node_t *node, int c) {
