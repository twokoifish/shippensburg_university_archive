...
public class TestObjectiveController
{
    ...
    private static List<ClientPlayerQuestStateDTO> generateQuests(int quests, int objectivesPer)
    {
        ...
        for (int i = 1; i <= quests; i++)
        {
            ...
            {
                ClientPlayerObjectiveStateDTO objectiveDTO = new ClientPlayerObjectiveStateDTO(j, String.format("quest%dobjective%d", i, j), 0, ObjectiveStateEnum.TRIGGERED, false, true, "", 1, QuestStateEnum.TRIGGERED);
