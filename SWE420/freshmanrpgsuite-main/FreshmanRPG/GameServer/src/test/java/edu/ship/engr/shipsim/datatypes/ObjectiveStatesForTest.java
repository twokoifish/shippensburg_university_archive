...
public enum ObjectiveStatesForTest
{
     ...
     *
     */
    MARTY_QUEST5_ADV1(PlayersForTest.MARTY.getPlayerID(), 5, 1,
            ObjectiveStateEnum.TRIGGERED, false),
    /**
     *
     */
    MARTY_QUEST11_ADV1(PlayersForTest.MARTY.getPlayerID(), 11, 1,
            ObjectiveStateEnum.TRIGGERED, false),
    /**
     *
     */
    HERSH_TELEPORTATION_ADV1(PlayersForTest.HERSH.getPlayerID(),
            QuestsForTest.TELEPORT_QUEST.getQuestID(), 1,
            ObjectiveStateEnum.TRIGGERED, true),
    /**
     *
     */
    HERSH_TELEPORTATION_ADV2(PlayersForTest.HERSH.getPlayerID(),
            QuestsForTest.TELEPORT_QUEST.getQuestID(), 2,
            ObjectiveStateEnum.TRIGGERED, true),
    /**
     *
     */
    HERSH_EXPIRED(PlayersForTest.HERSH.getPlayerID(),
            QuestsForTest.EXPIRED_QUEST.getQuestID(), 1,
            ObjectiveStateEnum.TRIGGERED, true),
    /**
     *
     */
    HERSH_QUEST_EXPIRED(PlayersForTest.HERSH.getPlayerID(),
            QuestsForTest.EXPIRED_QUEST.getQuestID(), 2,
            ObjectiveStateEnum.HIDDEN, true),
     ...
     *
     */
    PLAYER8_QUEST10_ADV1(PlayersForTest.GA.getPlayerID(),
            QuestsForTest.DOUBLOON_QUEST.getQuestID(),
            ObjectivesForTest.QUEST10_OBJECTIVE_1.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, true),
    ...
    NEWBIE_ONRAMPING_Q(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_PRESS_Q.getQuestID(),
            ObjectivesForTest.ONRAMPING_PRESS_Q.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),
    NEWBIE_ONRAMPING_I(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_OPEN_CLOSET.getQuestID(),
            ObjectivesForTest.ONRAMPING_OPEN_CLOSET.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),
    ...
    NEWBIE_ONRAMPING_MOVE_UP(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_MOVE_FORWARD.getQuestID(),
            ObjectivesForTest.ONRAMPING_MOVE_FORWARD.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),
    ...
    NEWBIE_ONRAMPING_MOVE_DOWN(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_MOVE_BACKWARD.getQuestID(),
            ObjectivesForTest.ONRAMPING_MOVE_BACKWARD.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),
    ...
    NEWBIE_ONRAMPING_MOVE_RIGHT(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_MOVE_RIGHT.getQuestID(),
            ObjectivesForTest.ONRAMPING_MOVE_RIGHT.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),
    ...
    NEWBIE_ONRAMPING_MOVE_LEFT(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_MOVE_LEFT.getQuestID(),
            ObjectivesForTest.ONRAMPING_MOVE_LEFT.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),

    /**
     *
     */
    NEWBIE_ONRAMPING_TERMINAL_MAN(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_TERMINAL_MAN.getQuestID(),
            ObjectivesForTest.ONRAMPING_TERMINAL_MAN.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),

    /**
     *
     */
    NEWBIE_ONRAMPING_INTERACTABLE(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_INTERACTABLE.getQuestID(),
            ObjectivesForTest.ONRAMPING_INTERACTABLE.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),

    /**
     *
     */
    EASTER_EGG_OBJ_STATE(PlayersForTest.EASTEREGG_PLAYER.getPlayerID(),
            ObjectivesForTest.EASTER_EGG_STEP_1.getQuestID(),
            ObjectivesForTest.EASTER_EGG_STEP_1.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),

    HISTORY_QUEST_OBJ_STATE(PlayersForTest.BIKE_PLAYER.getPlayerID(),
            ObjectivesForTest.RESPONSE_FROM_HISTORY_NPC.getQuestID(),
            ObjectivesForTest.RESPONSE_FROM_HISTORY_NPC.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),

    HISTORY_QUEST_OBJ_STATE2(PlayersForTest.BIKE_PLAYER.getPlayerID(),
            ObjectivesForTest.RESPONSE_FROM_HISTORY_NPC.getQuestID(),
            ObjectivesForTest.RESPONSE_FROM_HISTORY_NPC2.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),

    HISTORY_QUEST_OBJ_STATE3(PlayersForTest.BIKE_PLAYER.getPlayerID(),
            ObjectivesForTest.RESPONSE_FROM_HISTORY_NPC.getQuestID(),
            ObjectivesForTest.RESPONSE_FROM_HISTORY_NPC3.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),

    /**
     *
     */
    TIMED_OBJECTIVE_QUEST_OBJ(PlayersForTest.JEFF.getPlayerID(),
            ObjectivesForTest.RUN_TO_OTHER_POSITION.getQuestID(),
            ObjectivesForTest.RUN_TO_OTHER_POSITION.getObjectiveID(),
            ObjectiveStateEnum.HIDDEN, false),

    NEWBIE_ONRAMPING_XP_BUFF(PlayersForTest.NEWBIE.getPlayerID(),
            ObjectivesForTest.ONRAMPING_XP_BUFF.getQuestID(),
            ObjectivesForTest.ONRAMPING_XP_BUFF.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),
    MERLIN_FIND_THE_LIBRARY(PlayersForTest.MERLIN.getPlayerID(),
            ObjectivesForTest.EXPLORING_FIND_LIBRARY.getQuestID(),
            ObjectivesForTest.EXPLORING_FIND_LIBRARY.getObjectiveID(),
            ObjectiveStateEnum.TRIGGERED, false),
     ...
     *
     */
    SCORE_SPECIFY_DATE(41, 112, 1, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE2(42, 112, 2, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE3(43, 114, 3, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE4(44, 113, 3, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE5(45, 113, 1, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE6(46, 114, 2, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE7(47, 112, 1, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE8(48, 112, 1, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE9(49, 114, 3, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE10(50, 113, 2, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),
    SCORE_SPECIFY_DATE11(51, 114, 3, ObjectiveStateEnum.COMPLETED, false,
            LocalDate.now().with(TemporalAdjusters.previous(
                    DayOfWeek.SATURDAY)));
     ...
     */
    ObjectiveStatesForTest(int playerID, int questID, int objectiveID,
                           ObjectiveStateEnum state,
    ...
    ObjectiveStatesForTest(int playerID, int questID, int objectiveID,
                           ObjectiveStateEnum state,
                           boolean needsNotification, LocalDate dateCompleted)
    {
        this.objectiveID = objectiveID;
        this.questID = questID;
        this.playerID = playerID;
