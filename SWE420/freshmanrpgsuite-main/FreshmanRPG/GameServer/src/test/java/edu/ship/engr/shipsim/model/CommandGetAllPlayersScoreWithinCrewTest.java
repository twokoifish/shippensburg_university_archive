...
public class CommandGetAllPlayersScoreWithinCrewTest
{
    @Test
    public void testGetAllPlayersScoresWithinCrew() throws DatabaseException
    {
...
//        }};
        ...
        when(questScoreMock.getWeeklyScoresByCrew(1, start, end)).thenReturn(
                playerScoresBefore);

        when(objectiveScoreMock.getWeeklyScoresByCrew(1, start,
                end)).thenReturn(
                playerScoresBefore);
        ...
        CommandGetAllPlayersScoreWithinCrew cmd =
                new CommandGetAllPlayersScoreWithinCrew(1, start, end);
        cmd.execute();
        ...
        verify(obs, times(1)).receiveReport(argThat(report ->
                {
                    ...
                    //verify(obs, times(1)).receiveReport(new
                    // GetAllPlayersScoreReport(playerScoresAfter));
