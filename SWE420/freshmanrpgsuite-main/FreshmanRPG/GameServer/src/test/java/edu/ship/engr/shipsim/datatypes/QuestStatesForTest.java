...
public enum QuestStatesForTest
{
     ...
     *
     */
    MARTY_QUEST5(PlayersForTest.MARTY.getPlayerID(), 5,
            QuestStateEnum.TRIGGERED, false, false),
    /**
     *
     */
    MARTY_QUEST11(PlayersForTest.MARTY.getPlayerID(), 11,
            QuestStateEnum.EXPIRED, false, false),
    /**
     *
     */
     ...
     */
    NEWBIE_ONRAMPING(PlayersForTest.NEWBIE.getPlayerID(),
            QuestsForTest.ONRAMPING_QUEST.getQuestID(),
            QuestStateEnum.TRIGGERED, true, false),
    /**
     *
     */
    TEST_EASTEREGG(PlayersForTest.EASTEREGG_PLAYER.getPlayerID(),
            QuestsForTest.EASTER_EGG_QUEST.getQuestID(),
            QuestStateEnum.TRIGGERED, true, true),
    /**
     *
     */
    TEST_HISTORYQUEST(PlayersForTest.BIKE_PLAYER.getPlayerID(),
            QuestsForTest.TEST_HISTORY_RESPONSE_QUEST.getQuestID(),
            QuestStateEnum.TRIGGERED, false, false),
    /**
     *
     */
    TEST_TIMED_OBJECTIVE_QUEST(PlayersForTest.JEFF.getPlayerID(),
    ...
    MERLIN_EXPLORING(PlayersForTest.MERLIN.getPlayerID(),
            QuestsForTest.EXPLORATION_QUEST.getQuestID(),
            QuestStateEnum.TRIGGERED, false, false),
    /**
     *
     */
    ...
    SCORE_SPECIFY_DATE(44, 112, QuestStateEnum.FULFILLED, false, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),

    SCORE_SPECIFY_DATE2(45, 113, QuestStateEnum.FULFILLED, false, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),

    SCORE_SPECIFY_DATE3(46, 113, QuestStateEnum.FULFILLED, false, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),

    SCORE_SPECIFY_DATE4(47, 114, QuestStateEnum.FULFILLED, false, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),

    SCORE_SPECIFY_DATE5(48, 114, QuestStateEnum.FULFILLED, false, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),


    SCORE_SPECIFY_DATE6(49, 114, QuestStateEnum.FULFILLED, false, false,
            LocalDate.now()
                    .with(TemporalAdjusters.previousOrSame(DayOfWeek.SUNDAY))),

    SCORE_SPECIFY_DATE7(51, 114, QuestStateEnum.FULFILLED, false, false,
...
//	TEST_TRIGGER_QUEST(1, 106, QuestStateEnum.AVAILABLE, true);
     ...
     * @param questState          the state of the quest for the specified
     *                            player
     * @param needingNotification true if this player should be notified
     *                            about the
     *                            state of this quest
     */
    ...
    {
        return new QuestStateRecordDTO(this.playerID, this.questID,
                this.questState, this.needingNotification, this.dateCompleted);
    }
