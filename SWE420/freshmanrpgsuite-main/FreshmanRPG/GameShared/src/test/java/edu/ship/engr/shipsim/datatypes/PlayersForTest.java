...
public enum PlayersForTest
{
    ...
    RYAN(15, "Ryan", "female_a", 52, 52, "pw", "quad.tmx", 1111, null, 0, 13, Crew.OFF_BY_ONE, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    ...
    SCORE_PLAYER1(41, "ScoreP1", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OFF_BY_ONE, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER2(42, "ScoreP2", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OFF_BY_ONE, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER3(43, "ScoreP3", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OFF_BY_ONE, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER4(44, "ScoreP4", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OFF_BY_ONE, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER5(45, "ScoreP5", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OUT_OF_BOUNDS, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER6(46, "ScoreP6", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OUT_OF_BOUNDS, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER7(47, "ScoreP7", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OUT_OF_BOUNDS, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER8(48, "ScoreP8", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OUT_OF_BOUNDS, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER9(49, "ScoreP9", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OFF_BY_ONE, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    SCORE_PLAYER10(50, "ScoreP10", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OUT_OF_BOUNDS, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad"))),
    LAST_SATURDAY(51, "LastSaturday-BadResult", "female_a", 52, 53, "pw", "quad.tmx", 1111, null, 0, 0, Crew.OUT_OF_BOUNDS, Major.COMPUTER_ENGINEERING, 1, 0, false, new ArrayList<>(Arrays.asList("Rec Center", "Quad")));
