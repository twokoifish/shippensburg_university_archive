...
public class PlayerRowDataGatewayTest
{
    ...
    /**
     * Tests updating crew for a player
     *
     * @throws DatabaseException should
     */
    @Test
    public void testUpdateCrewIdForPlayer() throws DatabaseException
    {
        PlayerRowDataGateway firstMerlin = findGateway(PlayersForTest.MERLIN.getPlayerID());
        assertEquals(2, firstMerlin.getCrew().getID());
        firstMerlin.updateCrewID(3);
        assertEquals(3, firstMerlin.getCrew().getID());
    }
