...
class Player extends Equatable {
  ...
  Map<String, dynamic> toJson() {
    return {'playerID': playerID, 'playerName': playerName, 'experiencePoints': experiencePoints};
  }
  ...
  factory Player.fromJson({
    ...
    return Player(playerID: json['playerID'], playerName: json['playerName'], experiencePoints: json['experiencePoints']);
  }
}
